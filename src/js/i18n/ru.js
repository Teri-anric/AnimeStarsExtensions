export const AnimeStarExtensionTranslationRussian = {
    ...
    'club-boost-auto': 'Автоматический вклад в клуб',
    ...
    'remove': 'Удалить',
    'clubs-boost-block-images': 'Блокировать изображения карт в топе клуба',
    ...
    'club-boost-replace-stale-description': 'Если за это время карта на экране так и не сменилась (никто не забирает её из взносов) — нажимается замена (скип). Отдельно сразу скипает, если никто из клуба не может внести эту карту (пустой список «Могут внести»). Работает только при включённом «Автоматический клад карт».',
    ...
    'club-boost-hotkey-description': 'Горячие клавиши для управления бустом клуба:\n' +
        '- B: Включить/Выключить автоматический вклад в клуб\n' +
        '- C: Включить/Выключить автоматический скип карт',
    ...
    'upload-card-data-to-ass': 'Отправлять данные о карточках на ASS',
    'upload-card-data-to-ass-description': 'Индексация метаданных карточек (название, изображение и т.д.) для поиска на сайте; отключите, если не хотите отправлять эти данные',
    'api-website-label': 'Сайт ASS',
    'api-website-description': 'Официальный сайт для интеграции с API и поиска карт.',
