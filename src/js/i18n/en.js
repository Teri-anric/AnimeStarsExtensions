const AnimeStarExtensionTranslationEnglish = {
    ...
    'site-domains': 'Site domain(s)',
    'site-domains-add-label': 'Add domain manually (when the site changes domain)',
    'site-domains-add-btn': 'Add domain',
    'site-domains-help': 'Add the website domain, then reload the site tab.',
    'site-domains-empty': 'No additional domains.',
    'site-domains-invalid': 'Invalid domain. Enter a hostname or URL (e.g. animestars.org).',
    'site-domains-requesting': 'Saving domain…',
    'site-domains-added': 'Domain added. Reload the website page.',
    'site-domains-removing': 'Removing domain…',
    'site-domains-removed': 'Domain removed.',
    'site-domains-error': 'Error',
    'remove': 'Remove',
    'clubs-boost-block-images': 'Block card images on club boost page',
    ...
    'upload-card-data-to-ass': 'Upload card metadata to ASS',
    'upload-card-data-to-ass-description': 'Sends card metadata (name, image, etc.) for site search; turn off if you do not want this data sent',
    'api-website-label': 'ASS website',
    'api-website-description': 'Official site used for API integration and card search.',
    ...
    'remelt-topbar-enabled': 'Simplify and move smelting top bar to the top of the page',
    ...
    'export-error': 'Error exporting configuration',
    'invalid-config-file': 'Invalid configuration file format',
